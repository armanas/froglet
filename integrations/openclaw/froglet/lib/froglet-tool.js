  ...
  return {
    ...
    properties: {
      ...
      hosting: {
        type: "object",
        description:
          "Hosting backend for marketplace_publish. kind must be local, tor, or self.",
        properties: {
