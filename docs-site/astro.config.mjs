...
export default defineConfig({
	...
	integrations: [
			...
			head: [
				...
				{ tag: 'link', attrs: { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Instrument+Sans:wght@400;500;600;700&family=JetBrains+Mono:wght@400;600;700&family=Newsreader:wght@400;500;600;700&display=swap' } },
			],
