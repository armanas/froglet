...
export const routeAgentMetadata = {
	home: {
		...
		evidence_boundary: 'The publishing candidate is under qualification; local evidence does not prove public activation or recipient execution.',
	...
	publish: {
        ...
        evidence_boundary: 'Candidate qualification is pending. Installation, local execution, public reachability, marketplace activation, and recipient execution are separate evidence.',
